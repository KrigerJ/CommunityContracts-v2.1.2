    ...
    public class GeorgeProfile
    {
        ...
        public static class GeorgeContract
        {
            ...
            public static float EstimateContractValue()
            {
                ...
                profile.ProductOneMultiplier = 10.0f + (profile.NPCLevel * 1.00f);
            ...
            public static void GeorgeStats()
            {
                int currentFriendship = Game1.player.friendshipData.TryGetValue(profile.CharacterName, out var data) ? data.Points : 0;

                string dialogText =
                    T("GeorgeBrewerInfo", new { npc = profile.CharacterName, level = profile.NPCLevel, quality = profile.QualityName }) + "\n\n" +
                    T("GeorgeKegInfo", new { npc = profile.CharacterName, count = profile.ProcessorsOperated }) + "\n\n" +
