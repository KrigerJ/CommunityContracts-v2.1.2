    ...
    public class EvelynProfile
    {
        ...
        public static class EvelynContract
        {
            ...
            public static async void OfferDetailedContract()
            {
                ...
                {
                    processingLine =
                        T("EvelynPreparedCloth", new { count = profile.ProcessorsOperated, quality = profile.QualityName }) + "\n\n" +
            ...
            public static void EvelynStats()
            {
                int currentFriendship = Game1.player.friendshipData.TryGetValue(profile.CharacterName, out var data) ? data.Points : 0;

                string dialogText =
                    T("EvelynKeeperInfo", new { npc = profile.CharacterName, level = profile.NPCLevel, quality = profile.QualityName }) + "\n\n" +
                    T("EvelynLoomInfo", new { npc = profile.CharacterName, count = profile.ProcessorsOperated }) + "\n\n" +
